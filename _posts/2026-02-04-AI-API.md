...
## 方法
vibe coding必须要做的：
1. 确定现在要做的项目（不能太大，大项目要拆分成小项目），针对项目建git仓库
2. 建立plan.md，有思路就写好思路，分阶段分点，每一步都清楚。
3. 没有思路就建立一个rule.md放prompt，把数据说明和需求写清楚，越细节越好
4. 每次AI生成都让AI先读一遍rule和plan，避免因太长的上下文而遗忘
